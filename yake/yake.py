...
class KeywordExtractor(object):
    ...
    def __init__(self, lan="en", n=3, dedupLim=0.9, dedupFunc='seqm', windowsSize=1, top=20, features=None, stopwords=None, min_term_length: int = 3):
        self.lan = lan
    ...
    def extract_keywords(self, text):
        try:
            ...
            text = text.replace('\n\t',' ')
            dc = DataCore(lan=self.lan, text=text, stopword_set=self.stopword_set, windowsSize=self.windowsSize, n=self.n, min_term_length=self.min_term_length)
